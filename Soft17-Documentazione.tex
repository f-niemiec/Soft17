...
utilizzato \textbf{GridSearchCV} per la selezione degli iperparametri, operando
...
\section{Introduzione al ruolo di Markov}
...
Un Processo di Ricompensa di Markov è definito come la quarta:
\[
...
\subsubsection{Markov ed il Blackjack}
