...
\subsection{Modeling}
Prima di parlare degli algoritmi utilizzati occorre fare delle premesse. Per scegliere i migliori parametri adatti agli algoritmi e il problema che stiamo affrontando abbiamo deciso di utilizzare una \textbf{griglia di ricerca} per comprendere i valori adatti agli iperparametri. È una classe contenuta nella libreria scikit-learn che ci permette di testare più combinazioni di parametri automaticamente evitando di rieseguire manualmente i training.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1.00\textwidth]{img/SARSArewardDistribution.png}
