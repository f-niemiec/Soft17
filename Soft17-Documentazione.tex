...
\subsection{Pipeline 2 – Q-Learning Offline}
La seconda pipeline adotta un approccio di Q-learning offline, nel quale
...
diretto con la pipeline online, che considera anch'essa solo le azioni
...
L'algoritmo di Q-learning offline implementato nella seconda pipeline
...
Q-table vuota e iperparametri identici a quelli utilizzati nella pipeline
online: $\alpha = 0.1$ e $\gamma = 0.9$.
...
implementato un ambiente di test identico a quello utilizzato nella
pipeline online. L'agente viene valutato su un milione di episodi,
...
Rispetto alla pipeline online, si osserva una riduzione del
...
grandezza più rapido rispetto alla pipeline online.
...
Il confronto sistematico tra le due pipeline rivela differenze significative in termini di prestazioni, efficienza computazionale e robustezza. Dal punto di vista delle prestazioni pure, l'implementazione online si 
...
sovrastime o sottostime locali. La pipeline offline, invece, è vincolata alla distribuzione statistica del dataset e non può 
