...
\begin{itemize}
    \item \textbf{ max depth che specifica la profondità massimache l'albero può raggiungere con i seguenti valori: [10,20,30]}
    \item \textbf{ min samples split: che determina numero minimo di campioni prima di effettuare un'ulteriore ramificazione. I valori sono: [2,5]}
    \item \textbf{ min samples leaf, che determina il numero minimo di campioni che devono essere presenti nelle foglie. I valori sono: [1,2]}
\end{itemize}
