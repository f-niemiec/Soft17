...
\begin{itemize}
    ...
    \item $\gamma$: termine che regola come comportarsi nel corso della ricerca della soluzione. Fa in modo che più vicino si arriva alla soluzione, maggiore sarà la preferenza verso dei reward a breve termine.
...
Nelle seguenti figure è possibile osservare il progredire  del modello fino a raggiungere risultati vicini alla \textit{basic strategy} inizialmente illustrata. Nell'ultima figura è possibile visualizzare graficamente la policy appresa dall'agente durante il training. 
...
Qui è possibile osservare una tabella di riepilogo che contiene tutti i risultati ottenuti con gli approcci che prevedevano l'utilizzo di Reinforcement Learning. 
